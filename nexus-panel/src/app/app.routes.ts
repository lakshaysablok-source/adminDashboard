...
export const routes: Routes = [
  ...
  // Main dashboard shell (with sidebar)
  {
    ...
    children: [
      ...
      { path: 'kanban',       loadComponent: () => import('./features/kanban/kanban.component') },
      ...
      { path: 'invoice',      loadComponent: () => import('./features/invoice/invoice.component') },
      { path: 'file-manager', loadComponent: () => import('./features/file-manager/file-manager.component') },
      { path: 'ecommerce/products',       loadComponent: () => import('./features/ecommerce/products/products.component') },
      { path: 'ecommerce/product-detail', loadComponent: () => import('./features/ecommerce/product-detail/product-detail.component') },
      { path: 'ecommerce/orders',         loadComponent: () => import('./features/ecommerce/orders/orders.component') },
      { path: 'ecommerce/order-detail',   loadComponent: () => import('./features/ecommerce/order-detail/order-detail.component') },
      { path: 'users',         loadComponent: () => import('./features/users/users.component') },
      { path: 'users/roles',   loadComponent: () => import('./features/users/roles.component') },
      ...
      { path: 'blog/posts',       loadComponent: () => import('./features/blog/posts/posts.component') },
      { path: 'blog/post-detail/:id', loadComponent: () => import('./features/blog/post-detail/post-detail.component') },
