...
export const routes: Routes = [
  ...
  // Main dashboard shell (with sidebar)
  {
    ...
    children: [
      ...
      { path: 'kanban',       loadComponent: () => import('./features/kanban/kanban.component'),           data: { breadcrumb: 'Kanban'         } },
      { path: 'calendar',     loadComponent: () => import('./features/calendar/calendar.component'),       data: { breadcrumb: 'Calendar'       } },
      { path: 'chat',         loadComponent: () => import('./features/chat/chat.component'),               data: { breadcrumb: 'Chat'           } },
      { path: 'invoice',      loadComponent: () => import('./features/invoice/invoice.component'),         data: { breadcrumb: 'Invoice'        } },
      { path: 'file-manager', loadComponent: () => import('./features/file-manager/file-manager.component'), data: { breadcrumb: 'File Manager' } },
